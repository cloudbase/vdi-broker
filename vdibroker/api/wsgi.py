...
from vdibroker import i18n
from vdibroker.i18n import _, _LE, _LI
...
class Application(object):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            [app:wadl]
            latest_version = 1.3
            paste.app_factory = vdibroker.api.fancy_api:Wadl.factory

        which would result in a call to the `Wadl` class as

            import vdibroker.api.fancy_api
...
class Request(webob.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'vdibroker.best_content_type' not in self.environ:
            ...
            self.environ['vdibroker.best_content_type'] = (content_type or
                                                           'application/json')

        return self.environ['vdibroker.best_content_type']
...
class Middleware(Application):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            paste.filter_factory = vdibroker.api.analytics:Analytics.factory
        which would result in a call to the `Analytics` class as
            import vdibroker.api.analytics
...
def _set_request_id_header(req, headers):
    context = req.environ.get('vdibroker.context')
    if context:
